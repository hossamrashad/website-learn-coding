...
!(function(window, document, undefined) {
    ...
    function testProps(A, e, t, n) {
        ...
        for (
            var i, a, d, s, l, c = ["modernizr", "tspan", "samp"]; !mStyle.style && c.length;
    ...
    Modernizr.addTest("applicationcache", "applicationCache" in window),
        ...
        Modernizr.addTest(
            "ie8compat", !window.addEventListener &&
    ...
    Modernizr.addTest("supports", newSyntax || oldSyntax),
        ...
        Modernizr.addTest(
            "es6collections", !!(window.Map && window.Set && window.WeakMap && window.WeakSet)
        ),
    ...
    isSVG ||
        !(function(A, e) {
            ...
            function i(A, t, n) {
                ...
                return (
                    (r = n.cache[A] ?
                        ...
                        n.createElem(A)), !r.canHaveChildren || h.test(A) || r.tagUrn ?
                    r :
            ...
            function a(A, t) {
                ...
                t = t || o(A);
                for (
                    var r = t.frag.cloneNode(), i = 0, a = n(), d = a.length; d > i; i++
                )
                    r.createElement(a[i]);
                return r;
            }
            ...
            function l(A) {
                for (
                    ...
                    (e = t[r]), o.test(e.nodeName) && i.push(e.applyElement(c(e)));
                return i;
            }
            ...
            function c(A) {
                for (
                    var e,
                        t = A.attributes,
                        n = t.length,
                        r = A.ownerDocument.createElement(b + ":" + A.nodeName); n--;

                )
                    (e = t[n]), e.specified && r.setAttribute(e.nodeName, e.nodeValue);
    ...
    Modernizr._q.push(function() {
        ...
        Modernizr.addAsyncTest(function() {
            function A() {
                ...
                for (
                    var e = "R0lGODlhAQABAIAAAAAAAP///ywAAAAAAQABAAACAUwAOw=="; e.length < 33e3;
    ...
    Modernizr.addTest("audio", function() {
        ...
        Modernizr.addTest(
            "adownload", !window.externalHost && "download" in createElement("a")
        ),
    ...
    Modernizr.addTest("todataurljpeg", function() {
        ...
        Modernizr.addTest("csspositionsticky", function() {
            var A = "position:",
                ...
                n = t.style;
            return (
                (n.cssText = A + prefixes.join(e + ";" + A).slice(0, -A.length)), -1 !== n.position.indexOf(e)
            );
        }),
        ...
        Modernizr.addTest(
            "inputformaction", !!("formAction" in createElement("input")), { aliases: ["input-formaction"] }
        ),
        Modernizr.addTest(
            "inputformenctype", !!("formEnctype" in createElement("input")), { aliases: ["input-formenctype"] }
        ),
        Modernizr.addTest(
            "inputformmethod", !!("formMethod" in createElement("input"))
        ),
        Modernizr.addTest(
            "inputformtarget", !!("formtarget" in createElement("input")), { aliases: ["input-formtarget"] }
        ),
        ...
        Modernizr.addTest(
            "textareamaxlength", !!("maxLength" in createElement("textarea"))
        ),
        Modernizr.addAsyncTest(function() {
            function A(i) {
                r++, clearTimeout(e);
    ...
    Modernizr.addTest("crypto", !!prefixed("subtle", crypto)),
        ...
        Modernizr.addTest(
            "fullscreen", !(!prefixed("exitFullscreen", document, !1) &&
        ...
        Modernizr.addTest(
            "requestanimationframe", !!prefixed("requestAnimationFrame", window), { aliases: ["raf"] }
        ),
    ...
    Modernizr.addTest("getrandomvalues", !!supportsGetRandomValues),
        ...
        Modernizr.addTest(
            "requestautocomplete", !!prefixed("requestAutocomplete", createElement("form"))
        ),
        Modernizr.addTest(
            "speechrecognition", !!prefixed("SpeechRecognition", window)
        );
    ...
    Modernizr.addTest(
        ...
        Modernizr.addTest(
            "peerconnection", !!prefixed("RTCPeerConnection", window)
        ),
        ...
        Modernizr.addTest("cssfilters", function() {
            ...
            var A = createElement("a");
            return (
                (A.style.cssText = prefixes.join("filter:blur(2px); ")), !!A.style.length &&
